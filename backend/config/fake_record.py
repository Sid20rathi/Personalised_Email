...
def adding_user(name:str,email:str,password:str,clerk_id:str):
    user = Users(name=name,email=email,password=password,clerk_id=clerk_id)
...
if __name__ == "__main__":
    adding_user(
        name="Siddhant Rathi",
        email="siddhant.rathi@example.com",
