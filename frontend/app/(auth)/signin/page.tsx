...
export default function Signin() {
  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 w-full h-screen selection:bg-blue-600 selection:text-white ">
      <div className="bg-black flex flex-col justify-center items-center p-10 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md space-y-6 text-center">
          <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200 tracking-tighter">
            Welcome <br />
            <span className="text-blue-500">Back</span>
          </h1>
          <p className="text-neutral-300 text-lg leading-relaxed font-light">
            Resume your <span className="text-white font-extrabold font-serif ">tailored outreach</span>.
            Your personalized email agents are ready to use.
          </p>
        </div>
        {/* Decorative overlay for readability if needed, though PixelBlast is transparent */}
      ...
      <div className="flex flex-col items-center justify-center m-5">
        <div className="w-md  shadow-2xl p-5  rounded-md">
          ...
          <form onSubmit={handleSubmit(Submit)}>
            ...
            <div className="mt-5">
              <button className="w-full mb-3  bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded-md" type="submit">{loading ? "Loading..." : "Sign in"}</button>
            </div>
            <div>
              <div className="text-sm flex items-center justify-center text-black">
                Don't have an account? <span className="text-blue-500 font-bold cursor-pointer hover:underline pl-2" onClick={toSignup}>Sign up</span>
              </div>
            </div>
          </form>
        </div>
